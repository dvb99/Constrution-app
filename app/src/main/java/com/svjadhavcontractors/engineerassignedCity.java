...
public class engineerassignedCity extends AppCompatActivity {
    ...
    eachSiteInEngineer.Engineer_delete_Adapter adapterforassignedcity;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tableuserPpl.addListenerForSingleValueEvent(new ValueEventListener() {
          ...
          // clue how to do that
                ...
                engineerassignedCity.this.adapterforassignedcity = new eachSiteInEngineer.Engineer_delete_Adapter(engineerassignedCity.this, assignedCity);
